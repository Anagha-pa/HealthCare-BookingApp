...
class ListAppointments(serializers.ModelSerializer):
   ...
   class Meta:
      model = Appointments
      fields = ['id','first_name','last_name','age','gender','slot_date','department','doctor','fee','doctor_name','status','time','address','phone_number']
...
class DoctorViewSerializer(serializers.ModelSerializer):
   class Meta:
      model = UserAccount
      fields = ['id','first_name','qualification','department','available','is_doctor']      
